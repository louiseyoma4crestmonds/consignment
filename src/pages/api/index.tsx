...
export async function trackingIdIsValid(trackingId: string) {
  const response = await axios
    .get(`${SERVER_URL}/bb-consignment/is-trackingId-valid/${trackingId}`)
    .then((res) => res)
    .catch((err) => err.message);
  return response;
}

export async function getTrackingId(trackingId: any) {
  const response = await axios
    .get(`${SERVER_URL}/bb-consignment/get/${trackingId}`)
    .then((res) => res)
    .catch((err) => err.message);
  return response;
}

export async function getTrackingIdHistory(trackingId: any) {
  const response = await axios
    .get(`${SERVER_URL}/bb-consignment/${trackingId}/history`)
    .then((res) => res)
    .catch((err) => err.message);
  return response;
}
